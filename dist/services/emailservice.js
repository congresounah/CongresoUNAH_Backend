...
exports.RecordatorioEmail = exports.sendAllCertificates = exports.sendVerificationEmail = void 0;
...
const RecordatorioEmail = (to) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const info = yield transporter.sendMail({
            from: `"Congreso" <${process.env.EMAIL_USER}>`,
            to,
...
exports.RecordatorioEmail = RecordatorioEmail;
